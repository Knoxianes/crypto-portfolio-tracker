...
const Search: FC<Props> = ({ className, transactionType, setSelectedCoin, setTransactionType, selectedCoin, userData }) => {
  ...
  const onChangeInput = (e: ChangeEvent<HTMLInputElement>) => {
    const newList = coinListForFilter.filter((currentValue: string) => {
  ...
  return (
    <div className={className}>
      ...
      <div className="w-full h-20 border border-gray-300 rounded-lg px-6 py-2 gap-4 flex items-center justify-between cursor-pointer">
        ...
        {drawerOpen &&
          <div className="absolute w-[452px] top-[43.5%] border-2 border-gray-300 max-h-60 overflow-y-scroll noscrollbar rounded-lg flex flex-col gap-2 left-[35.3%] shadow-md shadow-gray-300 bg-white p-6">
            {
